...
import com.mobilearts.nftworld.databinding.FragmentWeightBinding
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            nextButtonTV.setOnClickListener {
                findNavController().navigate(WeightFragmentDirections.actionWeightFragmentToExerciseFragment(weight,gender))
            }
        }
